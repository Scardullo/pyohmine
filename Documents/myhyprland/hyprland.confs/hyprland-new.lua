...
-- window.drag()). This form (bare table, single-letter direction, no hl.dsp.window.move
-- wrapper) comes from hyprconf2lua's conversion, which did NOT flag it for manual review
-- -- still worth a real-world test once you're actually on 0.55+, since it's structurally
-- unlike every other dispatcher call in this file.
