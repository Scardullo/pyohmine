/*
 raw_tcp_part_e_sliding_window.c
 Part E: User-space TCP with sliding window + slow start

 Build:
   gcc raw_tcp_part_e_sliding_window.c -o raw_tcp_part_e

 Run:
   sudo ./raw_tcp_part_e eth0 <dst_ip> <dst_port>
*/
