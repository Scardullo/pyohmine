/*
 raw_tcp_part_f_fullduplex.c
 Part F: Full duplex user-space TCP with receive window + reassembly

 Build:
   gcc raw_tcp_part_f_fullduplex.c -o raw_tcp_part_f

 Run:
   sudo ./raw_tcp_part_f eth0 <dst_ip> <dst_port>
*/
