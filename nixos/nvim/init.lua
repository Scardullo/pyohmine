-- ============================================
-- vscode.lua - Modern Neovim Setup (VS Code Dark+ theme)
...
require("lazy").setup({
  ...
  -- Color scheme (VS Code Dark+ default)
  { "Mofiqul/vscode.nvim" },
...
require("vscode").setup({
  -- "dark" = VS Code's default Dark+ theme
  style = "dark",
  transparent = false,
...
-- LSP Setup
-- ============================================
-- nvim-lspconfig ships default server configs under its lsp/ directory;
-- vim.lsp.enable() picks them up automatically (no require("lspconfig") needed).
